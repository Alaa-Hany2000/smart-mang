    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{trans("main.Add Bill")}}/مرتجع</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">{{trans("main.Add Bill")}}\مرتجع</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <form action="{{route('billsreback.store')}}" id="addUserForm" class="form-horizontal" role="form" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-10">
                                                              ...
                                                              <option value="" selected="selected" disabled>{{trans('main.Product')}}</option>
                                                               ...
                                                               <td  class="col-sm-2"> <input style="max-width:70px;" type="number" readonly name="allow" id="allow"></td>
                                                                 <td  class="col-sm-2"> <input type="number" name="prices[]" id="priceone"style="max-width: 86px;" ></td>
                                                                   <td class="col-sm-2"><input type="number" style="max-width: 85px;"  name="amounts[]" value="1"  min="1" step="1" id="rangeone"><input type="number" disabled style="max-width: 87px;" id="rr" class="border border-dark "/></td>
...
$(allow).val(response.total);
  $(amount).val(1);
  $(amount).attr('max',1000);
   $(amount).attr('title', response.total);


   $(price).val(response.max_price);
