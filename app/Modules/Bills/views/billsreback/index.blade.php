    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{trans("main.Bills")}}/مرتجع</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a  href="#">{{trans("main.Bills")}}\مرتجع</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header" >
                                <a class="btn btn-primary"  href="{{route('billsreback.create')}}">{{trans("main.Add Bill")}}</a>
                            </div>
