					...
					<div class="">
						<div class="flax" style="max-hight:120px;">
							<div class="row" >
								...
								<h4 class="text-center">فاتوره مرتجع بيع</h4>
								<div class="row">
  ...
  <tbody>
   ...
   <td class="text-right">{{$sale->total}}</td>
								...
								<div class="col-sm-4" style=" display: inline; " >
									<h6 class="text-left" style=" display: inline; " >01013210</h6>
								</div>
								<div class="col-sm-4" style=" display: inline; " >
									<h6 class="text-center" style=" display: inline; " >{{$settings->ar_title}}</h6>
								</div>
								<div class="col-sm-4" style=" display: inline; " >
