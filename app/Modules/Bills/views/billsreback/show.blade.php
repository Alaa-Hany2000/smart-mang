...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">بيانات المرتجع</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
            <a href="{{route("printPageback",$bill->id)}}" target="_blank" class="btn btn-seccess btn-sm" >طباعة<i class="fad fa-shredder"></i> </a>
                <div class="row">
