    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">بيانات التلفيات</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">بيانات التلفيات</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
            <a href="{{route("printPagedamage",$bill->id)}}" target="_blank" class="btn btn-seccess btn-sm" >طباعة<i class="fad fa-shredder"></i> </a>
                <div class="row">
