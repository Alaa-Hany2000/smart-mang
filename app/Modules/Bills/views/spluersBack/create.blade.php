    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{trans("main.Add Bill")}}/مرتجع وارد</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">{{trans("main.Add Bill")}}</a></li>
                            <li class="breadcrumb-item active">{{trans("main.Add Bill")}}/مرتجع وارد</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <form action="{{route('spluersBack.store')}}" id="addUserForm" class="form-horizontal" role="form" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-10">
                                                              ...
                                                              <option value="" selected="selected" disabled>{{trans('main.Product')}}</option>
                                                               ...
                                                               <td  class="col-sm-2"> <input style="max-width:70px;" type="number" readonly name="allow" id="allow"></td>
                                                                 <td  class="col-sm-2"> <input type="number" name="prices[]" id="priceone"style="max-width: 86px;" ></td>
                                                                   <td class="col-sm-2"><input type="number" style="max-width: 85px;"  name="amounts[]" value="1"  min="1" step="1" max="10000" id="rangeone"></td>
