...
class adminCustomeresController extends Controller
{
    /**
...
//                    $editUrl = url('cp/blog/edit'.$row->id);
                   $btn = '<a href="' . route('adminCustomers.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>';
                    $btn =$btn.'
                     <form action="' . url('admin/adminCustomers/delete', $row->id) . '" id="delform2" method="get" style="display: inline-block">
