                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{trans("main.Add Suppliers")}}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    <h2>{{trans('main.Add_Suppliers')}}</h2>
                                    <form action="{{route('adminSuppliers.store')}}" method="post" name="registration">
                                        @csrf
                                        ...
                                        <input type="text" name="phone" id="phone" class="form-control" placeholder="0000"/>
                                        </div>
                                        <div class="form-group">
