                                ...
                                <div class="tab-content" id="custom-content-below-tabContent">
                                    <div class="tab-pane fade show active" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            @endif
                                            <form role="form" class="form-horizontal col-md-12" id="eventForm" action="{{route('adminProducts.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                                                @method('PUT')
                                                @csrf
                                                <div class="form-group row">
                                                    <label for="title" class="col-sm-2 col-form-label">كود</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="slug" id="code"  value="{{$product->slug}}" class="form-control" placeholder="ادخل كود غير مكرر"  />
                                                    </div>
                                                </div>
                                                    <div class="form-group row">
                                                   ...
                                                   <!--  <div class="form-group row">
                                                    ...
                                                    <div id="target">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="datetime-local" name="produce_at"  value="{{$product->produce_at}}" id="produce_at" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="to_date" class="col-sm-2 col-form-label">{{trans("main.Expired_at")}}</label>
                                                            <div class="col-sm-10">
                                                                <input type="datetime-local" name="expired_at"  value="{{$product->expired_at}}" id="expired_at" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="buy_price" id="buy_price"  value="{{$product->buy_price}}" class="form-control">
                                                        </div>
                                                    </div>
                                                <div class="form-group row">
                                                    <label for="buy_price" class="col-sm-2 col-form-label"> نسبه الخصم</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="rival" id="rival"  value="{{$product->rival}}" class="form-control" placeholder="%ادخل نسبه الخصم" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="buy_price" class="col-sm-2 col-form-label"> نسبه الخصم الاضافي</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="addRival" id="addRival"  value="{{$product->addRival}}" class="form-control" placeholder="%ادخل نسبه الخصم الاضافي" />
                                                    </div>
                                                </div>
                                                    <div class="form-group row">
                                                        <label for="slug" class="col-sm-2 col-form-label">{{trans("main.Max_price")}}</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="max_price" id="max_price"  value="{{$product->max_price}}" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
...
@push('js')
    <script>
        ...
        $(function() {
            ...
            editor.setData("{!!html_entity_decode($product->description)!!}");
        });
    </script>
    <script>
