    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">الحضور والانصراف مخصص </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">الحضور والانصراف مخصص </a></li>
                            <li class="breadcrumb-item active">الحضور والانصراف مخصص </li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">الحضور والانصراف مخصص </h3>
                            </div>
                            <div class="card-header" style="border-bottom: none">
                                <form method="get" action="{{route('adminFiltter.getfillter')}}">
                                    @csrf
                                    <div class="form-group col-lg-4">
                                        <label for="exampleFormControlInput1"> اختر تاريخ</label>
                                        <input type="date" name="date" class="form-control" id="exampleFormControlInput1" >
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label for="exampleFormControlSelect1">اختر مخزن</label>
                                        <select class="form-control" name="mstore">
                                    ...
                                    <div class="form-group col-lg-4">
                                        <label for="exampleFormControlSelect1">اختر موظف</label>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input type="submit" class="btn btn-success " value="رشح">
                                    </div>
    ...
    <script>
        $(document).ready(() => {
            ...
            let table = $('#facility_cat').DataTable({
                ...
                "autoWidth": false,
                ajax: {
                    url: "{{ route('adminFiltter.getfillter') }}",
                    type: 'GET',
                },
                columns: [
                    {data: "id" },
