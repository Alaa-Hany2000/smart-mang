...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style=" background-image: linear-gradient(to bottom, #bdb659, #c5c054, #d0cb4b,#69662d, rgba(0,0,0,1))!important; ">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="NavBar">
            ...
            @else
                <li class="nav-item">
                    <a class="nav-link " href="/admin/dashboard">{{trans('main.Profile')}} </a>
                </li>
            @endif
        </div>
    </div>
...
<div class="wrapper">
    ...
    <div class="card  tt " style="margin-top: 20% ; max-width: content-box ; overflow-x: hidden  ">
        ...
        <div class="col-lg-6 col-sm-12">
            ...
            <form>
                ...
                <button type="submit" class="btn btn-warning round-2 col-lg-12">{{trans('main.Send')}}</button>
            </form>
