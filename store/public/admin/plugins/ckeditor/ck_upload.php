...
$upload_dir = array(
    'img' => $_SERVER['DOCUMENT_ROOT'] . "/alwablycoop/public/upload/events/" //"http://worldclass-tt.com/public/upload/content/",
//    'img'=> "public/upload/countries",
);
...
//            $url = '../../../upload/content/'. $upload_dir . $f_name;
...
// Append the host(domain name, ip) to the URL.
            $link .= $_SERVER['HTTP_HOST']."/alwablycoop/public/";

// Append the requested resource location to the URL
         //  $link .= $_SERVER['REQUEST_URI'];

            $url = $link . '/upload/events/' . $f_name;
            ...
            $re = '<script>alert("Unable to upload the file to ' . $uploadpath . " " . $_FILES['upload']['error'] . '")</script>';
        }
    } else {
