...
Route::group(array('prefix' => 'admin'), function () {
    ...
    Route::get('/login', \App\Modules\Admin\Controllers\AdminController::class . "@getLogin")->name('login');
    Route::post('/login', \App\Modules\Admin\Controllers\AdminController::class . "@postLogin");
